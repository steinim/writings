...
Sitatet er hentet fra et [mandat](http://nfbnet.org/pipermail/nfbcs_nfbnet.org/2011-October/003472.html) utstedt av Jeff Bezos, CEO i Amazon, i 2002 i følge en tidligere ansatt. Mandatet påla at alle team må eksponere funksjonalitet og data gjennom API-er og at teamene kun har lov til å kommunisere med hverandre via API-ene. Ingen unntak. Beslutningen om at alle team i Amazon kun skulle kommunisere over API-er dannet mye av grunnlaget for at Amazon kunne gå fra å kun være en bokhandel til å også bli den ledende tilbyderen av skyplattform i verden ([AWS](https://aws.amazon.com/)).
